...
if not SKIP_CUDA_BUILD:
    ...
    if HIP_BUILD:
        ...
        # RTX 50xx (Blackwell) uses compute capability 12.0 (sm_120), which
        # requires a sufficiently new CUDA Toolkit (e.g. 12.8+).
        # Add both SASS and PTX for forward-compatibility.
...
def get_package_version():
    with open(Path(this_dir) / PACKAGE_NAME / "__init__.py", "r", encoding="utf-8") as f:
